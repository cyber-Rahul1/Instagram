...
const LoginFooter = ({page}) => {
    ...
    return (
        <div className={`w-full lg:flex left-0 flex flex-col justify-center items-center md:mt-20 lg:mt-14 bg-black   ${page === "signUp" ? 'pt-4 pb-4' : (page === "forgotPassword") ? 'absolute bottom-12 left-0' : (page === "Otp") ? ' pt-18' : (page === 'login') ? 'mt-16' : ''}`}>
