...
const Suggested = ({ page, setShowFollowers, setShowFollowing, followersPage }) => {
    ...
    if (loading) {
        return <div className={`w-screen h-screen flex pt-2 md:pt-0 items-start md:items-center justify-start md:justify-center flex-col px-5 md:px-0 gap-5 ${(theme === 'dark' && !followersPage) ? 'bg-black' : (theme === 'light') ? 'bg-white' : ''}`}>
