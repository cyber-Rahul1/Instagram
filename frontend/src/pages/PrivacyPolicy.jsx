            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="bg-white dark:bg-black">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-[#c5c1bcc4] text-sm">Effective Date: January 1, 2025</p>
                    </div>

                    {/* Introduction */}
                    <section className="mb-8">
                        <p className="text-gray-700 dark:text-[#ffffffe9] text-base leading-6 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">What Information We Collect</h2>
                        <div className="text-gray-700 dark:text-[#ffffffe9] text-base leading-6 space-y-4">
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-[#c5c1bcc4]">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Information We Collect Automatically</h3>
                                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-[#c5c1bcc4]">
                    ...
                    <section className="mb-8">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">How We Use Information</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Your Rights and Choices</h2>
                        <div className="text-gray-700 dark:text-[#ffffffe9] text-base leading-6 space-y-4">
